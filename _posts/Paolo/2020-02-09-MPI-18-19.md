...
*  **[MPI a.a. 2020-2021]({{ site.baseurl }}/assets/mpi_88.pdf)**,  diapositive in formato handout.
Ho aggiunto varie animazioni, reso uniforme e modificato alcune parti rispetto all'anno precedente.
In totale ci Sono 159 diapositive (con le transizioni sarebbero quasi  il trilpo).
